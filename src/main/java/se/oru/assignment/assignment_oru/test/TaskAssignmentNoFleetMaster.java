...
import se.oru.assignment.assignment_oru.SimpleOptimizationProblem;
...
public class TaskAssignmentNoFleetMaster {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Task task6 = new Task(6,startPoseGoal6,goalPoseGoal6,ROBOT_TYPE.MOBILE_ROBOT);
	
		//TaskAssignmentSimulatedAnnealing assignmentProblem = new TaskAssignmentSimulatedAnnealing();
		SimpleOptimizationProblem assignmentProblem = new SimpleOptimizationProblem();
		int numPaths = 1;
